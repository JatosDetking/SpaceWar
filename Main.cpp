...
public:
	...
	{
		glm::vec3 otherColor(0.f, 1.f, 0.f);
		if (HP == 2)
		{
			otherColor = glm::vec3(1.f, 1.f, 0.f);
		}
		if (HP == 1)
		{
			otherColor = glm::vec3(1.f, 0.f, 0.f);
		}
		if (ALive() == true)
		{
			glBindVertexArray(m_vao);
...
public:
		...
		myLaser(Laser(glm::vec3(pos.x, pos.y, pos.z + 4)))
	{
		...
		//2 FKE KGE
		//F
		vertices.push_back(Vertex(-0.75f, -0.5f, 1.f, .20f, 0.0f, 0.f, 0.0f, 0.0f));
		//K
		vertices.push_back(Vertex(-1.75f, -0.5f, 1.f, .20f, 0.0f, 0.f, 0.5f, 0.0f));
		//E
		vertices.push_back(Vertex(-0.75f, 0.5f, 1.f, .20f, 0.0f, 0.f, .0f, .5f));

		vertices.push_back(Vertex(-1.75f, -0.5f, 1.f, .20f, 0.0f, 0.f, 0.5f, 0.0f));
		//G
		vertices.push_back(Vertex(-1.75f, 0.5f, 1.f, .20f, 0.0f, 0.f, 0.5f, .5f));
		vertices.push_back(Vertex(-0.75f, 0.5f, 1.f, .20f, 0.0f, 0.f, .0f, .5f));
		...
		vertices.push_back(Vertex(-1.75f, 0.5f, 0.f, .20f, 0.0f, 0.f, 0.5f, 0.0f));
		vertices.push_back(Vertex(-0.75f, 0.5f, 1.f, .20f, 0.0f, 0.f, 0.5f, .5f));
		vertices.push_back(Vertex(-1.75f, 0.5f, 1.f, .20f, 0.0f, 0.f, .0f, .5f));
...
public:
		...
		p(pos)
	{
		...
		vertices.push_back(Vertex(0.5f, -0.5f, -0.5f, .20f, 0.0f, 0.f, 4.0f, 0.0f));
		vertices.push_back(Vertex(0.5f, 0.5f, -0.5f, .20f, 0.0f, 0.f, 4.0f, 4.0f));
		vertices.push_back(Vertex(0.5f, 0.5f, -0.5f, .20f, 0.0f, 0.f, 4.0f, 4.0f));
		vertices.push_back(Vertex(-0.5f, 0.5f, -0.5f, .20f, 0.0f, 0.f, 0.0f, 4.0f));
		vertices.push_back(Vertex(-0.5f, -0.5f, -0.5f, .20f, 0.0f, 0.f, 0.0f, 0.0f));
	...
	virtual void CreateVAO()
	{
		...
		{
			int width, height, nrChannels;
			std::shared_ptr<unsigned char> pData = std::shared_ptr<unsigned char>(stbi_load("Resources/space3.jpg", &width, &height, &nrChannels, 0), stbi_image_free);
			if (!pData)
				throw std::exception("Failed to load texture");
